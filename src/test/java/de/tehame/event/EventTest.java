...
public class EventTest {
	...
	@Test
	public void test() {
		PhotoMetadaten m1 = new PhotoMetadaten("egal", 10, 10, 1920, 1080, "egal", "egal");
		...
		PhotoMetadaten m2 = new PhotoMetadaten("egal", 10, 10, 1920, 1080, "egal", "egal");
		p.bestimmeEvent(m2);
		...
		PhotoMetadaten m3 = new PhotoMetadaten("egal", 80, 80, 1920, 1080, "egal", "egal");
		p.bestimmeEvent(m3);
		...
		PhotoMetadaten m4 = new PhotoMetadaten("egal", -90, -90, 1920, 1080, "egal", "egal");
		p.bestimmeEvent(m4);
